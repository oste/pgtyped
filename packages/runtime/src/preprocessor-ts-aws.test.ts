...
test('(TS) name parameter interpolation', () => {
  ...
  const expectedResult = {
    ...
    // bindings: ['123', 12],
    query: 'SELECT id, name from users where id = :param1 and age > :param2',
    bindings: [
      { name: 'param1', value: { stringValue: '123' } },
      { name: 'param2', value: { longValue: 12 } },
    ],
    mapping: [],
  };

  const result = processTSQueryASTForAWS(parsedQuery.query, parameters);
...
test('(TS) pick parameter interpolation (multiline)', () => {
  ...
  const expectedResult = {
    ...
    bindings: [
      {
        name: 'param1',
        value: { stringValue: JSON.stringify({ num_frogs: 1002 }) },
      },
      { name: 'param2', value: { longValue: 1 } },
      { name: 'param3', value: { stringValue: 'reminder' } },
    ],
    mapping: [],
  };

  const result = processTSQueryASTForAWS(parsedQuery.query, parameters as any);
...
test('(TS) scalar param used twice', () => {
  ...
  const expectedResult = {
    ...
    // bindings: ['123'],
    query:
      'SELECT id, name from users where id = :param1 and parent_id = :param1',
    bindings: [{ name: 'param1', value: { stringValue: '123' } }],
    mapping: [],
  };
...
test('(TS) name parameter mapping', () => {
  ...
  const expectedResult = {
    ...
    query:
      'SELECT id, name from users where id = :param1 and age > :param2 and parent_id = :param1',
    bindings: [
      { name: 'param1', value: { stringValue: '1234-1235' } },
      { name: 'param2', value: { longValue: 33 } },
    ],
    mapping: [],
  };

  const result = processTSQueryASTForAWS(parsedQuery.query, {
    id: '1234-1235',
    age: 33,
  });
...
test('(TS) single value list parameter interpolation', () => {
  ...
  const expectedResult = {
    ...
    // bindings: [],
    query:
      'INSERT INTO users (name, age) VALUES (:param1, :param2) RETURNING id',
    bindings: [],
    mapping: [
      {
        name: 'user',
...
test('(TS) single value list parameter interpolation twice', () => {
  ...
  const expectedResult = {
    ...
    query:
      'INSERT INTO users (name, age) VALUES (:param1, :param2) BOGUS (:param1, :param3) RETURNING id',
    bindings: [
      {
        name: 'param1',
      ...
      {
        name: 'param3',
        value: { stringValue: '1234-123-1233' },
      },
    ],
    mapping: [],
  };
...
test('(TS) multiple value list (array) parameter mapping', () => {
  ...
  const expectedResult = {
    ...
    // bindings: [],
    query:
      'SELECT FROM users where (age in (:param1) and age in (:param1)) or (age in (:param2))',
    bindings: [],
    mapping: [
      {
        name: 'ages',
...
test('(TS) multiple value list (array) parameter interpolation', () => {
  ...
  const expectedResult = {
    ...
    // bindings: [23, 27, 50],
    query:
      'SELECT FROM users where age in (:param1, :param2, :param3) or parent_age in (:param1, :param2, :param3)',
    bindings: [
      { name: 'param1', value: { longValue: 23 } },
      { name: 'param2', value: { longValue: 27 } },
      { name: 'param3', value: { longValue: 50 } },
    ],
    mapping: [],
  };
...
test('(TS) multiple value list parameter mapping twice', () => {
  ...
  const expectedResult = {
    ...
    // bindings: [],
    query:
      'INSERT INTO users (name, age) VALUES (:param1, :param2), (:param1) RETURNING id',
    bindings: [],
    mapping: [
      {
        name: 'users',
...
test('(TS) multiple value list parameter interpolation', () => {
  ...
  const expectedResult = {
    ...
    query:
      'INSERT INTO users (name, age) VALUES (:param1, :param2), (:param3, :param4) RETURNING id',
    bindings: [
      { name: 'param1', value: { stringValue: 'Bob' } },
      { name: 'param2', value: { longValue: 12 } },
      { name: 'param3', value: { stringValue: 'Tom' } },
      { name: 'param4', value: { longValue: 22 } },
    ],
    mapping: [],
  };
...
test('(TS) multiple value list parameter interpolation twice', () => {
  ...
  const expectedResult = {
    ...
    query:
      'INSERT INTO users (name, age) VALUES (:param1, :param2), (:param3, :param4), (:param5, :param6), (:param7, :param8) RETURNING id',
    bindings: [
      { name: 'param1', value: { stringValue: 'Bob' } },
      { name: 'param2', value: { longValue: 12 } },
      { name: 'param3', value: { stringValue: 'Tom' } },
      { name: 'param4', value: { longValue: 22 } },
      { name: 'param5', value: { stringValue: 'Bob' } },
      { name: 'param6', value: { longValue: 12 } },
      { name: 'param7', value: { stringValue: 'Tom' } },
      { name: 'param8', value: { longValue: 22 } },
    ],
    mapping: [],
  };
...
test('(TS) query with empty spread params', () => {
  ...
  const result = processTSQueryASTForAWS(parsedQuery.query, { ids: [] });
...
test('(TS) query with empty spread params', () => {
  ...
  const result = processTSQueryASTForAWS(parsedQuery.query, { params: [] });
...
test('(TS) query with underscores in key names and param names', () => {
  ...
  const expectedResult = {
    ...
    // bindings: ['one', 'two'],
    query: 'INSERT INTO data.action_log (_id, _name) VALUES (:param1, :param2)',
    bindings: [
      { name: 'param1', value: { stringValue: 'one' } },
      { name: 'param2', value: { stringValue: 'two' } },
    ],
    mapping: [],
  };
...
test('(TS) all kinds mapping ', () => {
  ...
  const expectedResult = {
    ...
    // bindings: [],
    query:
      'SELECT :param1 :param2 :param1 (:param3) :param2 (:param4) (:param3) (:param4, :param5, :param6) (:param7, :param8) (:param6)',
    bindings: [],
    mapping: [
      {
        name: 'userId',
